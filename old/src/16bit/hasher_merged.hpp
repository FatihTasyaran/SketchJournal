...
public:
  TabularHashMerged() { 
   ...
   void modhash(const uint32_t data, uint16_t results[8], uint16_t modul) const {
    ...
    results[0] = ((int)results[0] % modul); 
    results[1] = ((int)results[1] % modul);
    results[2] = ((int)results[2] % modul);
    results[3] = ((int)results[3] % modul);
    results[4] = ((int)results[4] % modul);
    results[5] = ((int)results[5] % modul);
    results[6] = ((int)results[6] % modul);
    results[7] = ((int)results[7] % modul);
  }
  
  
  void hash(const uint32_t data, uint16_t results[8]) const {
