...
void experiment_single_table_mbp(CSketch_MP<stype, dtype>& csketch, dtype* data, std::pair<stype, dtype>* &freq_decreasing) {
  ...
  for(unsigned nt = 4; nt <= no_max_threads; nt *= 2) {
...
#ifdef CERROR
      std::cout << "\terr:" << csketch.getError(freq_decreasing, TOP, separate_hash) << "\ttop_item(id:" <<  freq_decreasing[0].second << "\treal:" << freq_decreasing[0].first << "\tquery:" << csketch.query(freq_decreasing[0].second,separate_hash) << ")";
      csketch.printFreq(freq_decreasing, TOP, separate_hash, nt);
#endif
      std::cout << std::endl;
  }
...
void experiment_single_table_mbphalf(CSketch_MP<stype, dtype>& csketch, dtype* data, std::pair<stype, dtype>* &freq_decreasing) {
  double *times = new double[no_max_threads + 1];
  double *htimesthread = new double[no_max_threads + 1];
  double *htimestotal = new double[no_max_threads + 1];
  double *wtimesthread = new double[no_max_threads + 1];
...
#ifdef CERROR
      std::cout << "\terr:" << csketch.getError(freq_decreasing, TOP, separate_hash) << "\ttop_item(id:" <<  freq_decreasing[0].second << "\treal:" << freq_decreasing[0].first << "\tquery:" << csketch.query(freq_decreasing[0].second,separate_hash) << ")";
      csketch.printFreq2(freq_decreasing, TOP, separate_hash, nt);
#endif
      std::cout << std::endl;
  }
...
void experiment_single_table_mbpfull(CSketch_MP<stype, dtype>& csketch, dtype* data, std::pair<stype, dtype>* &freq_decreasing) {
  double *times = new double[no_max_threads + 1];
  double *htimesthread = new double[no_max_threads + 1];
  double *htimestotal = new double[no_max_threads + 1];
  double *wtimesthread = new double[no_max_threads + 1];
...
#ifdef CERROR
      std::cout << "\terr:" << csketch.getError(freq_decreasing, TOP, separate_hash) << "\ttop_item(id:" <<  freq_decreasing[0].second << "\treal:" << freq_decreasing[0].first << "\tquery:" << csketch.query(freq_decreasing[0].second,separate_hash) << ")";
      csketch.printFreq3(freq_decreasing, TOP, separate_hash, nt);
#endif
      std::cout << std::endl;
  }
...
int main(int argc, char** argv) {
  ...
  experiment_single_table_mbphalf(cms_mp, data, freq_decreasing);
  experiment_single_table_mbpfull(cms_mp, data, freq_decreasing);
