...
filename = ss + "_" + bs + "_" + col + "_" + distvar1 + "_" + "zipf2barrier" + ".txt"
...
filename = ss + "_" + bs + "_" + col + "_" + distvar1 + "_" + "zipf2" + ".txt"
...
filename = ss + "_" + bs + "_" + col + "_" + distvar1 + "_" + "zipf3barrier" + ".txt"
...
filename = ss + "_" + bs + "_" + col + "_" + distvar1 + "_" + "zipf3" + ".txt"
