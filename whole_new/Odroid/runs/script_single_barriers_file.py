...
fulls = [time_array_full, hash_array_full, write_array_full, through_array_full, err_array_full]
##DECLARATIONS##
...
for col in col_sizes:
    ...
    for i in range(5):
        ...
        appendName("HALF BARRIER", writer)
    ...
    for i in range(5):
        ...
        appendName("FULL BARRIER", writer)
        ...
        appendOneColVERSION(writer, fulls[i])
